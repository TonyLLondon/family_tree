...
export default function HomePage() {
  ...
  const sourcePageCount = getAllSourcePageSlugs().length;
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {([
              ...
              { href: "/sources", label: "Sources", desc: `${sourcePageCount} records and documents`, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> },
              ...
              { href: "/chart", label: "Family tree", desc: "Ancestor fan chart", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10"/><path d="M2 12h20"/></svg> },
            ]).map((item) => (
              <Link
                key={item.href}
                href={item.href}
