        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {([
              ...
              { href: "/chart", label: "Family tree", desc: "7-generation fan chart", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10"/><path d="M2 12h20"/></svg> },
            ]).map((item) => (
              <Link
                key={item.href}
                href={item.href}
