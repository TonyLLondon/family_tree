# Image-based corrections — Zerauschek (1) collection

Working document: 64 parish/civil-register scans in `media/collections/zerauschek/Zerauschek (1)/`.
Images read directly (no OCR script); ordered most-recent to oldest.
Confidence tags: **HIGH** (clear handwriting, structured grid), **MEDIUM** (legible but some characters uncertain), **LOW** (faded, tight binding, or narrative cursive).
...
## 3. Marriage Velzek Boara Zara 1886

**File:** `Marriage Velzek Boara Zara 1886.jpg`
**Register:** REGISTRO MATRIMONIALE, Regno di Dalmazia. Page Tav. 49. Five entries visible (N. 47–51).
**Confidence:** MEDIUM — structured grid; target entry appears to be N. 50.

**Relevant to:** Velzek–Boara marriage. Giovanni Francesco Velzek (born Spalato 1860, see image #8 below) marrying into the Boara family.

**Extracted:**
- Entry N. 50: Groom **Velzek** (or **Schek**) with birth year ~1860; bride **Boara** with Zara connections.
- Entry N. 51: Groom **Bealle Giuseppe**, bride **Frusca Margherita**.
- The Velzek–Boara connection is a lateral line; no existing person page covers this couple.

**Potential finding:** This image plus the `Birth Giovanni Francesco Velzek Spalato 1860.jpg` together establish a Velzek–Boara marriage alliance. The bride may be a Boara sibling of Ottilia Boara (wife of Pietro Pio Addobbati).

**Action:** Identify bride's full name and parents. Create or update a Boara-family note.

---

## 4. Marriage Zerauschek Herenda Pago 1878

**File:** `Marriage Zerauschek Herenda Pago 1878.jpg`
**Register:** REGISTRO MATRIMONIALE, Regno di Dalmazia. Pago parish. Entry N. 8.
**Confidence:** HIGH — structured 19th-century grid; clear columns.

**Relevant to:** [Antonio Zerauschek (senior)](../people/antonio-zerauschek-senior.md) (`@I25@`) × [Anna Herenda](../people/anna-herenda.md) (`@I26@`), marriage F13 (existing date: **26 Jan 1878**).

**Extracted:**
- **Marriage date: 26 January 1878** — matches existing. ✓
- **Groom: Antonio Zerauschek**, born **15 [month uncertain] 1850** in **Pago**. Existing says born **15 Mar 1850** in **Zara**. The birthplace discrepancy (**Pago** vs **Zara**) is notable — the birth register image (see #11 below) appears to be from Zara, not Pago. Possible explanations: the marriage register may record place of current residence rather than birthplace, or the family moved between the two.
- **Bride: Anna Herenda** (surname could read "Brenda" in the hand — initial H/B ambiguity in this script). Listed as **Negoziante** (merchant). Born **[day uncertain] Feb 1849** (or **1859**) in **Pago**. Existing says born **14 Feb 1859**. If the register truly says **1849**, Anna would be 10 years older than currently recorded — this needs very careful re-reading of the final digit.
- **Groom's father:** reads as **Biaggio** (i.e. Biagio). **Groom's mother:** reads as **Antonia**.
...
## 5. Marriage Kirchmayer Boara Zara 1869

**File:** `Marriage Kirchmayer Boara Zara 1869.jpg`
**Register:** REGISTRO MATRIMONIALE, Parrocchia di S. [Simeone?], Comune di Zara. Page Tav. 35. Six entries visible (N. 20–25).
**Confidence:** MEDIUM — structured grid; target entry is N. 24.

**Relevant to:** Kirchmayer–Boara marriage, a lateral Boara alliance.

**Extracted:**
- Entry N. 24 (1869): Groom **Kirchmayer**, bride linked to **Boara**.
- Entry N. 23: **Carlotta/o** — another entry.
- This establishes that the Boara family had additional marriage alliances beyond the Addobbati connection.

**Action:** Identify bride's Boara first name and parents. Cross-reference against Ottilia Boara's siblings.

---

## 6. Death Casimiro Carobbi Zara 1866

**File:** `Death Casimiro Carobbi Zara 1866.jpg`
**Register:** LIBRO DEGLI ATTI DI MORTE, page 16. Entries 65–70.
**Confidence:** MEDIUM — grid columns are clear; some handwriting in narrative cells is dense.

**Relevant to:** Carobbi family — connected via Marriage Boara Carobbi 1849 (see #12). Possibly the "Zio Casimiro" who lent money to Pietro Pio Addobbati (Fulvia memoir).

**Extracted:**
- Entry 70: **Carobbi** — male, Catholic. Death in **1866**, Zara.
- **Ultima malattia / motivi della Morte** column shows cause of death (partially legible — appears to include "Marasmo" / wasting).
- Parents column provides **Carobbi** father line.

**Potential finding:** If this is the **Casimiro Carobbi** from the Fulvia memoir (the kindly uncle who lent money to Pietro Pio and always waved off repayment), his death in **1866** would predate Pietro Pio's 1890 marriage by 24 years. That would mean the "Zio Casimiro" lending money was a different Casimiro, or the death date is for a different Carobbi generation. This matters for timeline accuracy.

**Action:** Read full name, age at death, and parents. Cross-reference against the 1849 Boara–Carobbi marriage.

---

## 7. Birth Evelina Boara Zara 1861

**File:** `Birth Evelina Boara Zara 1861.jpg`
**Register:** ATTI DI NASCITA, Parrocchia di Popovine (?). Page Tav. 22. Entries 159–164 visible.
**Confidence:** MEDIUM — bilingual headers (Italian / Croatian), structured grid.

**Relevant to:** Boara family. Evelina Boara born 1861 in Zara — likely a sibling or cousin of [Ottilia Anna Vincenza Boara](../people/ottilia-anna-vincenza-boara.md).

**Extracted:**
- Entry for **Evelina Boara** (exact row to be identified among 159–164).
- Parents' names, father's occupation, and godparents visible in grid.
- The bilingual (Italian + Croatian) format dates this to the mid-Habsburg administrative period.

**Action:** Extract parents' names; compare with Ottilia's parents to establish sibling vs cousin relationship.

---

## 8. Birth Giovanni Francesco Velzek Spalato 1860

**File:** `Birth Giovanni Francesco Velzek Spalato 1860.jpg`
**Register:** ATTI DI NASCITA, Spalato (Split). Page 85. Entries 52–57 visible.
**Confidence:** MEDIUM — handwriting varies by entry; some entries densely written.

**Relevant to:** Giovanni Francesco Velzek, who later marries into the Boara family (see #3, Marriage Velzek Boara 1886).

**Extracted:**
- One entry on this page records birth of **Giovanni Francesco Velzek** in **Spalato** (Split), 1860.
- Parents and godparents would establish the Velzek family origin in Spalato.

**Action:** Extract full entry; create lateral-line note.

---

## 9. Marriage Zerauschek Guerino Zara 1850

**File:** `Marriage Zerauschek Guerino Zara 1850.jpg`
**Register:** REGISTRO MATRIMONIALE, page 120/171. Entries 28–33 visible, covering 1850.
**Confidence:** MEDIUM — cleaner handwriting than some earlier entries; structured columns.

**Relevant to:** [Giuseppe Zerauschek](../people/giuseppe-zerauschek.md) (`@I115@`) × [Antonia Maria Guerino](../people/antonia-maria-guerino.md) (`@I116@`), marriage F58 (existing date: **24 Aug 1850**).
...
- **Zerauschek Biagio** — padre **defunto** (deceased by 1850)
- **Maria Schinkovz** — madre (alive in 1850 — no "defunto")
...
## 10. Birth Artemia Boara Zara 1850

**File:** `Birth Artemia Boara Zara 1850.jpg`
**Register:** LIBRO [degli atti di nascita], Parrocchia di Metropolitana, Comune di Zara. Page Tav. 21. Entries 84–89 visible.
**Confidence:** MEDIUM — structured grid; clear enough for column-level extraction.

**Relevant to:** Boara family. Artemia Boara born 1850 — potentially a sibling of [Ottilia Anna Vincenza Boara](../people/ottilia-anna-vincenza-boara.md) or of the previous generation.

**Extracted:**
- Entry 87 appears to show "Boara" in the father/mother column — child born 1850.
- Parents, godparents, and legitimacy status visible.

**Action:** Extract parents' names; compare with Ottilia's parents.

---

## 11. Birth Antonio Zerauschek Sr. Zara 1850 — RESOLVED

**File:** `Birth Antonio Zerauschek Sr. Zara 1850.jpg`
**Register:** LIBRO DEGLI ATTI DI NASCITA, page 83. Entries 54–59 visible.
**Confidence:** HIGH — structured grid; **confirmed by direct human reading (Tony, Mar 2026)**.

**Relevant to:** [Antonio Zerauschek (senior)](../people/antonio-zerauschek-senior.md) (`@I25@`), existing birth date: **15 Mar 1850**, Zara.

**Definitive reading (Mar 2026):**
- **Entry 54**
- **Birth:** 15 March 1850.
...
| Grandfather | Biagio Zerauschek | Biagio Zerauschek (`@I387@`) | **CONFIRMED** — appears as patronymic in father's entry |
| Mother | Guarino Antonia | Antonia Maria Guerino (`@I116@`) | **CONFIRMED** — same person, variant name order + "Maria" is additional given name |
...
**Remaining actions:**
- Add baptismal names **Giacomo Vincenzo** to `people/antonio-zerauschek-senior.md` and `family-tree.json`.
- Add direct image link to person page.
- Note the "Illegitimo crossed out" detail on the person page (replaces the "premarital birth pattern; confirm with baptism wording" open question).

---

## 12. Marriage Boara Carobbi Zara 1849

**File:** `Marriage Boara Carobbi Zara 1849.jpg`
**Register:** REGISTRO MATRIMONIALE, Parrocchia di S. Simeone, Comune di Zara. Page 45. Entries 2–8 visible, covering 1849.
**Confidence:** MEDIUM — structured columns; some water damage noted at left edge.

**Relevant to:** Boara–Carobbi marriage alliance. The Boara family connects to the Addobbati via Ottilia.

**Extracted:**
- One entry records the Boara–Carobbi marriage in 1849.
- Entry 4 or 5 appears to contain "Boara" names; entry 6 shows a date of 1849.
- Parents and witnesses visible.

**Action:** Extract full entry; cross-reference against Death Casimiro Carobbi (#6) and Ottilia Boara's parents.
...
## 15. Marriage Rovaro Brizzi Castellanich Zara 1821

**File:** `Marriage Rovaro Brizzi Castellanich Zara 1821.jpg`
**Register:** Narrative-format parish marriage book. Two entries visible: N. 29 and N. 30.
**Confidence:** LOW — dense narrative cursive (early 19th c.); long paragraphs without grid structure.

**Relevant to:** Parents of Geralda Rovaro Brizzi — a Rovaro Brizzi marrying a Castellanich in 1821 would be the previous generation.

**Extracted:**
- Entry N. 29 (the larger entry): Narrative records a marriage in 1821. Names "Rovaro Brizzi" and possibly "Castellanich" appear. The entry is a long block of continuous text with banns, ecclesiastical formulas, witness names.
- Entry N. 30: Another marriage on the same page.
- The dense cursive makes character-level extraction difficult without zooming.

**Action:** Flag for careful re-reading. This would establish the Rovaro Brizzi × Castellanich alliance one generation above Geralda.

---

## 16. Matrimonio Addobbati Coltelli Zara 1811

**File:** `Matrimonio Addobbati Coltelli Zara 1811.jpg`
**Register:** Narrative-format parish marriage book. Very dense double-page spread, heavily written.
**Confidence:** LOW — tight binding, faded document (archival labels visible); Napoleonic-era hand.

**Relevant to:** Addobbati × Coltelli marriage. In the tree, [Vincenzo Giovanni Domenico Valentino Addobbati](../people/vincenzo-giovanni-domenico-valentino-addobbati.md) married [(Domenica) Vincenza Coltelli](../people/domenica-vincenza-coltelli.md) — parents of Pietro Paolo Addobbati. Marriage presumably around this date.

**Extracted:**
- Two or three marriage entries visible in narrative format.
- At least one entry contains "Addobbati" and "Coltelli" surnames.
...
## 17. Birth Anastasia Castellanich Zara 1799

**File:** `Birth Anastasia Castellanich Zara 1799.jpg`
**Register:** Narrative-format baptismal book, 1799. Multiple entries on double-page spread.
**Confidence:** MEDIUM — 18th-c. cursive but reasonably clear; formulaic structure ("Adi X … battezzato/a …").

**Relevant to:** Castellanich family — connects to Rovaro Brizzi × Castellanich (1821 marriage) and the Paletta × Castellanich lines.

**Extracted:**
- Entry for "Anastasia" baptism clearly visible in right-page middle section ("Castellania" marginal label).
- Other entries: "Bersalina", "Mannurizzi", "Scarga" visible as marginal names.
- Each entry gives date, parents ("figlio/a di" + "moglie di"), godparents.

**Action:** Extract Anastasia's parents to link to the 1821 marriage.

---

## 18. Marriage Castellanich Paletta Zara 1796

**File:** `Marriage Castellanich Paletta Zara 1796.jpg`
**Register:** Narrative-format parish marriage book, 1796. Multiple entries across double-page spread.
**Confidence:** LOW–MEDIUM — faded document label; 18th-c. hand but with marginal name labels.

**Relevant to:** Castellanich × Paletta marriage alliance, which feeds into the Rovaro Brizzi line.

**Extracted:**
- Marginal labels include "Gasmich" (or Gesmich), "Calernich", "Olessanovich", "Gaean" (or Goran), and possibly "Castellanich."
- Several entries contain "Febr. 1796" and "Marzo 1796" dates.
- One entry near the bottom of the left page may contain the Castellanich–Paletta pairing.

**Action:** Identify the specific entry. Cross-reference with #17 (Anastasia Castellanich's parents).

---

## 19–20. Marriage Paletta Pettessich 1776 / Matrimonio Addobbati Rota 1775

**Files:** `Marriage Paletta Pettessich Zara 1776.jpg`, `Matrimonio Addobbati Rota Zara 1775.jpg`
**Register:** Narrative-format Zara marriage books, 1770s. Venetian-period handwriting.
**Confidence:** MEDIUM — marginal name labels help locate entries; narrative paragraphs contain formulaic phrases.

**Relevant to:**
- **1776:** Paletta × Pettessich — feeds into the Castellanich × Paletta alliance.
- **1775:** Addobbati × Rota — an earlier Addobbati marriage alliance (Sabalich p. 508 lists intermarriages but this specific couple is undated in the vault).

**Extracted (1775):**
- Marginal labels: "Tomasov", "Saray" (?), "Lession" (or Lessio), "Salischik" (or Sabalich?), "Saranich".
- At least one entry contains "Addobbati" — the marriage with "Rota."
- Each entry follows: "Dispensato le solite Pubblicaz[ioni] …" + banns + church + witnesses formula.
- Churches mentioned: S. Eufemia, S. Donato — both in Zara.

**Action:** Extract the Addobbati–Rota entry with parents, witnesses, church. Add to the Addobbati alliance network documented on `people/pietro-paolo-addobbati.md`.
...
- One entry at middle-left contains "Addobbati" margin label.
- Right-page entries from July 1766 also visible.

**Action:** Extract the Luigi Addobbati–Plarinò entry. This may be the marriage of Daniele Addobbati's son Luigi (see birth #37 below).

---

## 22. Marriage Boara Robustella Zara 1763

**File:** `Marriage Boara Robustella Zara 1763.jpg`
**Register:** Narrative-format parish marriage book, 1763. Tight binding.
**Confidence:** LOW–MEDIUM — narrative cursive; names at margins are clearer.

**Relevant to:** Boara × Robustella — an early Boara marriage alliance.

**Action:** Extract entry; establish the Boara patriline back to the 1760s.

---

## 23. Marriage Lorenzo Addobbati Campi Zara 1752

**File:** `Marriage Lorenzo Addobbati Campi Zara 1752.jpg`
**Register:** Narrative-format parish marriage book, 1751–1752. Entries from November 1751 and January 1752.
**Confidence:** MEDIUM — clear Venetian hand; formulaic text.

**Relevant to:** Lorenzo Addobbati × Campi. Another Addobbati alliance from the mid-18th century.

**Extracted:**
- Left page: entries from Nov–Dec 1751. "Eccealdi" or similar margin label; another entry with "Addobbati" label.
- Right page: entries from January 1752, including one referencing "Maggio" (January 9, 1752 entry).
- "Rohin" / "Bohin" entry also visible at right bottom (Jan 1752).

**Action:** Identify the Addobbati–Campi entry among the spread.
...
## 26. Death Margherita Lanfranchi Addobbati Zara 1749

**File:** `Death Margherita Lanfranchi Addobbati Zara 1749.jpg`
**Register:** Narrative-format death/burial book, late 1748 – early 1749. Page 83/397.
**Confidence:** MEDIUM — margin names in larger script; narrative formula includes age, sacraments, burial church.

**Relevant to:** Death of Margherita Lanfranchi, wife of Daniele Addobbati. Her death in 1749 aligns with Daniele's remarriage to Tori that same year.

**Extracted:**
- Left-page entries Dec 1748 – Jan 1749: "Margarita" appears first, possibly "moglie di" (wife of) a Donati or similar. Other marginal names: "Donati", "Colzani", "Bogezin", "Ausberti", "Marinelli."
- Right-page entries: Jan–Mar 1749. Marginal names: "Pasqualin", "Marinelli" (again), "Antoni" (age 70), "Malatesta" (age 70), "Duccini" (age 82), "Sollino/Zollino" (widow, age 84, buried in S. Francesco).
- The target "Margherita Lanfranchi" entry needs to be isolated — she may be on an adjacent page not fully visible.

**Action:** The filename specifies "Lanfranchi Addobbati" — locate the entry; confirm age at death, husband's name (should be Daniele Addobbati).
...
| Surname | Count | Date range | Parishes |
|---------|-------|------------|----------|
| **Addobbati** | 23 births | 1731–1760 | Zara |
| **Lanfranchi** | 9 births | 1707–1717 | Zara |
| **Plarinò** | 2 births | 1734–1736 | Zara |
| **Carobbi** | 1 birth | 1745 (Segna) | Segna |
| **Castellanich** | 1 birth | 1799 | Zara |

### Key observations from sampled images:

- **Birth Valentino Pietro Addobbati Zara 1732:** Appears to be the earliest Addobbati child in the collection. Parents' names visible — this establishes the founding couple of the Zara Addobbati line in the 1730s.
- **Birth Luigi Addobbati Zara 1744:** Born to Daniele Addobbati and his wife (Lanfranchi?). This Luigi is likely the groom in the 1766 Marriage Luigi Addobbati Plarinò.
- **Birth Simone Sallustio Addobbati Zara 1751:** Additional Addobbati child from the Daniele × Tori (second wife) branch.
- **Birth Simeone Addobbati Zara 1760:** Another generation marker.
- **Birth Santa Lanfranchi Zara 1707:** The oldest image in the collection. Baptismal entry from December 1707. Marginal label "Danca" or "Danze". Multiple entries visible from Dec 1707. Archival labels: "FADED DOCUMENT", "SMEARED INK", "REPAIRED DOCUMENT."
- **Birth Giovanni Battista Carobbi Segna 1745:** Only non-Zara birth in the collection; from **Segna** (Senj). Establishes the Carobbi line's geographic origin outside Zara.

### What these births collectively provide:

Each baptismal entry contains: **child's given names**, **parents** (father + mother including maiden name), **godparents/sponsors**, **legitimacy status**, **baptism date** (sometimes a few days after birth), and **parish**. Across 36 entries they reconstruct:
- The **Daniele Addobbati** family of children (both marriages)
- The **Lanfranchi** family tree in Zara (pre-1720)
- The **Plarinò** sibling set
- Godparent networks linking these families

---

---

# DAZD HR-DAZD-342 audit — findings vs `people/*.md`

Separate audit of the **DAZD Addobbati family fonds analytical inventory** ([`sources/corpus/dazd-addobbati-family-fonds/transcription-translation.en.md`](../sources/corpus/dazd-addobbati-family-fonds/transcription-translation.en.md)) against existing person pages. Kept here alongside the image findings so all known discrepancies are in one document.
...
One must be wrong or they refer to two different people. The inventory is explicit and sourced to matricula. **Cross-reference with image #16** (Matrimonio Addobbati Coltelli 1811): the marriage entry should give Vincenzo's age or birthdate, which would break the tie.

**Cross-reference with image collection:** The 23 Addobbati birth records in `Zerauschek (1)/` span **1731–1760** and do NOT cover 1776 or 1781. The birth record for Vincenzo is not in this scan collection — it would need a separate image from the Archbishop's baptism book 1778–1791 cited by DAZD.

---

## DAZD-2. Luigi Addobbati — spouse surname discrepancy

| Person page | Vault | DAZD inventory |
|-------------|-------|----------------|
...
## DAZD-3. Simeone Gilberto — name form + obit date

| Person page | Vault | DAZD inventory |
|-------------|-------|----------------|
| [`simeone-gilberto-addobbati.md`](../people/simeone-gilberto-addobbati.md) | Wife **Elisabetta Emilia Maria Luxardo**; KA "Elisabeth…". | **Elisa** Luxardo; obituary **21 Jun 1926** (page already cites that vs death **20 Jun**). |

Harmonisation only. The page already flags the 20 vs 21 June discrepancy. "Elisa" is a common short form of Elisabetta.

---

## DAZD-4. Missing relatives not in `people/`

| Finding | DAZD location | People impact |
|---------|---------------|---------------|
| **Daughter Anna** of Vincenzo and Vincenza Coltelli (with Pietro Paolo). | §2.2 narrative | [`vincenzo-…-addobbati.md`](../people/vincenzo-giovanni-domenico-valentino-addobbati.md) only lists **Pietro Paolo** under children. Anna needs adding. |
| **Daughter Margarita** of Luigi and Maddalena (with Pietro & Vincenzo). | §2.2 narrative | No `people/` page; [`luigi-anzolo-alloisio-addobbati.md`](../people/luigi-anzolo-alloisio-addobbati.md) does not list her. |
| **Giuseppe Addobbati** — petition with Domenico Calvi to the **doge** on **sardine-fishing rights**, **1788** (sig. 53). | Item 53 | [`luigi-anzolo-alloisio-addobbati.md`](../people/luigi-anzolo-alloisio-addobbati.md) names a brother Giuseppe in passing — no tied DAZD sig. Worth linking. |

---

## DAZD-5. Chronology / "first in Zara" nuance

| Person page | Vault | DAZD inventory |
|-------------|-------|----------------|
| [`d-daniele-addobbati.md`](../people/d-daniele-addobbati.md) | Stresses **1733** *cittadini* admission with brothers. | **1730** marriage Daniele + Margherita; **1731** two births; **1728** another Addobbati from Bergamo in **Turanj** registers. No 1733 line in the same form. |
| [`d-ioanes-addobbati.md`](../people/d-ioanes-addobbati.md) | DAZD cited for **1745 Bergamo** testimonial and **1733** admission. | Ties **Giovanni (Ivan)** to the **1745** Bergamo chain for the three brothers; 1733 not repeated verbatim the same way. |

Not a direct contradiction to the Sabalich story, but the DAZD inventory **adds** first Zadar register hits (**1730**, **1728 Turanj**) that predate the **1733** *cittadini* admission. The existing pages should note this when updated — "arrived by 1728/1730; formally admitted as *cittadini* 1733."

**Cross-reference with image collection:** The **Marriage Daniele Addobbati Lanfranchi 1730** image (#25) is the primary evidence for this pre-1733 presence. The **Birth Valentino Pietro Addobbati 1732** image is another early record. These images can independently confirm the DAZD inventory's dating.

---

## DAZD-6. Dr Pietro (golden spur / career)

[`dr-pietro-addobbati.md`](../people/dr-pietro-addobbati.md) is **largely consistent** with the inventory. 1769 inferred from age 63 in 1832; Padua 1786; Stratico titles; Nin 1804; no marriage noted. The inventory mainly duplicates what Sabalich already provided.

---

## DAZD-7. Pietro Paolo & Simeone — enrichment opportunities

[`pietro-paolo-addobbati.md`](../people/pietro-paolo-addobbati.md): Inventory matches **computista** / provincial accounting. Adds concrete sig numbers for future citation:
- **Sig. 36** — dowry (1811)
- **Sig. 38** — Balbi inheritance (1850)
- **Sig. 39** — 1854 procuration
- **Sig. 40** — poem (1870)
- **Sigs. 41–44** — Simeone notes/obit/fees/Linz letter

[`simeone-gilberto-addobbati.md`](../people/simeone-gilberto-addobbati.md): Inventory adds retirement rank **tenente maresciallo** vs the page's **Generalmajor** — different career stages, not a contradiction.

**Sig. 59 (1915)** — medical degree copy for **Pietro Addobbati**, **nephew of Simeone**: plausible tie to the doctor son described in [`pietro-pio-addobbati.md`](../people/pietro-pio-addobbati.md) (eldest son who died ~30 in Trieste of blood poisoning). Not yet cited on that page.

---

## DAZD-8. Early Angevin / Bergamo line

[`pietro-addobbati.md`](../people/pietro-addobbati.md) (1495): Inventory supports the 1745 Bergamo testimonial chain. The relevant cluster is **sig. 46** (not sig. 41 as possibly implied elsewhere). The person page is fine conceptually; any fix is on sig-number citation precision.

---

# Convergences between image collection and DAZD audit

Several findings from the two sources reinforce or constrain each other:
...
# Combined priority actions (ranked)
