---
title: "FamilySearch Family Tree — Pérez / Cerpa, Maule, Chile"
repository: FamilySearch
kind: collaborative-tree
family_tree_person_id: GJ1B-GS3
---
...
The vault cites **Family Tree person ID `GJ1B-GS3`** (stored on [Laurencia Pérez Escobar](../../../people/laurencia-perez-escobar-i347.md) as her FamilySearch Tree identifier). The same identifier is referenced on [Francisco Antonio Pérez Avejares](../../../people/francisco-antonio-perez-i350.md) for father-level details visible in that tree context.

| Topic | Tree assertion (summary) |
|-------|---------------------------|
| **Person ID** | `GJ1B-GS3` |
| **Household focus** | Pérez / Escobar line, Parral / Linares, Maule, Chile |
| **Father (display)** | **Francisco Antonio Pérez Avejares** — birth year **1882**; second surname **Avejares** (vault JSON label may shorten to “Francisco PEREZ”) |
| **Child — Laurencia** | **Laurencia** (del Carmen) **Pérez Escobar** — birth **16 July 1912**, Parral, Linares, Maule |
| **Other children (tree)** | María Estela, Jorge Antonio (b. 1918), María Lucinda (b. 1919) — as represented in the tree; not all have `people/` stubs yet |

## Conflict with earlier working tree (Laurencia’s birth year)

The collaborative tree gives Laurencia’s birth as **1912**. An earlier working tree in this vault had **27 March 1910**. **Civil registration** (or another primary record imaged and transcribed here) should be treated as authoritative once available; until then, **1912** is adopted from the tree as a working date with this caveat.
