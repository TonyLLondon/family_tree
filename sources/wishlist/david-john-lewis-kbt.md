# David John Lewis — Keep Britain Tidy sources wishlist

Person: [David John Lewis](../../people/david-john-lewis.md)

**Known:** David J. Lewis authored "The Keep Britain Tidy Group" in *Environmental Conservation* 5(1): 56, Spring 1978, with affiliation **Bostel House, 37 West Street, Brighton** — the KBT Group's headquarters. Family oral history: Director General. Died Brighton and Hove, 22 Aug 2000.

**In corpus:** Abstract page ([kbt-david-j-lewis-env-conservation-1978](../corpus/kbt-david-j-lewis-env-conservation-1978/)), KBT history ([keep-britain-tidy-history](../corpus/keep-britain-tidy-history/)), Wikipedia ([keep-britain-tidy-wikipedia](../corpus/keep-britain-tidy-wikipedia/)), Find That Charity ([kbt-findthatcharity-company-record](../corpus/kbt-findthatcharity-company-record/)), LoC authority ([loc-authority-keep-britain-tidy-group](../corpus/loc-authority-keep-britain-tidy-group/)), Lady Brunner / Oxford Mail ([kbt-founder-lady-brunner-oxford-mail](../corpus/kbt-founder-lady-brunner-oxford-mail/)).

---

## Priority 1 — paywalled article (purchase / institutional access)
...
| Source | What it gives |
|--------|---------------|
| **Keep Britain Tidy — direct contact** | The current charity may hold or know the location of historical records, photographs, or publications naming past Directors General. Contact: info@keepbritaintidy.org |
| **Brighton local press archives** | The Argus (Brighton) or Brighton & Hove Gazette may have covered Lewis's appointment, retirement, or local activities related to KBT. Available via British Newspaper Archive. |
