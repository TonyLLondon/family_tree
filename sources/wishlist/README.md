...
Sources **not yet** in corpus (or only partly used): URLs to open, books to buy, archives to contact. **Held inventory:** [../master-source-list.md](../master-source-list.md).

| Topic | File |
|-------|------|
| Étienne Stump — Iran dentistry, Mahmoudieh, popular refs | [stump.md](stump.md) |
...
| Saginashvili — Georgian National Archives remote request: Tbilisi church registers, military governor, nobility records for Saginashvili family pre-1811 | [saginashvili-georgian-archives.md](saginashvili-georgian-archives.md) |
