---
corpus: knecht-george-naturalisation-1864
kind: pdf
---

# George Knecht — Naturalisation Certificate (1864)
...
## Key facts from the certificate

| Field | Information |
|-------|-------------|
| **Origin** | **Bavaria** (not Hesse-Nassau as later census states) |
| **Age** | 49 in 1864 → **born c. 1815** |
| **Arrival** | 12 years in UK → arrived **c. 1852** |
| **Occupation** | Railway employee (Great Northern Railway Company) — possibly "Coach Builder" |
| **Address** | No. 1 Canonbury Terrace, Islington Road, Middlesex |
| **Family** | Married with one child |
| **Certificate No.** | 7799 |
| **Date sworn** | 5 September 1864 before E.L. Beaufort JP |

---

## Research value

- **German origin confirmed:** Bavaria, not Hesse-Nassau — redirects German church record searches to Bavarian archives
...
- [Glasscock / Knecht wishlist](wishlist/glasscock-knecht-line.md) — other records to acquire
- [Charles Knecht naturalisation (1869)](wishlist/glasscock-knecht-line.md#charles-knecht--possible-relative) — next priority
