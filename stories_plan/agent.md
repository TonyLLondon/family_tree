...
| Link from line hub | `topics/<relevant-hub>.md` | Add the story to the **Narratives** table in the correct line hub. Evans stories → `evans-cerpa-perez-london-chile.md`; Persia → `persia.md`; Zara → `zara-italy-dalmatia.md`. |
