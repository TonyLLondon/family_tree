# Pedigree collapse — Morgan Morgans & Lettice of Llywel
...
```mermaid
graph TD
    MM["Morgan Morgans<br/>bap. 1776, Llywel"]
    LT["Lettice<br/>maiden name unknown"]
    MM --- F243["⚭ marriage unknown"]
    LT --- F243

    F243 --> TM["Thomas Morgan<br/>bap. 1794, Llywel<br/>miner → moulder<br/>Nantyglo"]
    F243 --> WM["William Morgan<br/>bap. 1795, Llywel<br/>farmer, 263 acres<br/>Llanfairarybryn"]

    TM --- F217["⚭ 1823"]
    CD["Charlotte Davies<br/>Aberystruth"] --- F217
    F217 --> KM["Keziah Morgan<br/>b. 1824, Nantyglo<br/>collier, Dowlais"]

    KM --- F187["⚭"]
    JM["Jane<br/>b. ~1828, Dowlais"] --- F187
    F187 --> MaryM["Mary Morgan<br/>b. ~1854, Dowlais"]

    WM --- F242["⚭ 1831"]
    SW["Sarah Watkins<br/>b. ~1806"] --- F242
    F242 --> AM["Anne Morgan<br/>b. ~1829, Llanfair"]

    AM --- F188["⚭ ~1854"]
    TG["Thomas Griffiths<br/>b. 1830, Trecastle<br/>ironworks labourer"] --- F188
    F188 --> CG["Catherine Griffiths<br/>b. 1862, Aberdare<br/>tin worker"]

    MaryM --- FC["⚭"]
    DC["David Cushen<br/>b. 1853, Merthyr"] --- FC
    FC --> LC["Lily Cushen<br/>b. 1886, Merthyr"]

    CG --- F87["⚭ 1884"]
    DJL1["David John Lewis<br/>b. 1857, Aberavon<br/>coal hewer"] --- F87
    F87 --> SL["Samuel Lewis<br/>b. 1887, Aberdare<br/>coal miner → insurance agent"]

    SL --- F7["⚭ 1917<br/>THIRD COUSINS"]
    LC --- F7
    F7 --> DJL2["David John Lewis<br/>b. 1918, Aberdare<br/>Silver Star, Colonial Service"]

    style MM fill:#4a6741,color:#fff
    style LT fill:#4a6741,color:#fff
    style F7 fill:#8b4513,color:#fff
    style SL fill:#2c5282,color:#fff
    style LC fill:#2c5282,color:#fff
    style DJL2 fill:#1a365d,color:#fff
```
...
Third cousins share on average only 0.78% of their DNA. The marriage was not unusual, not scandalous, and not genetically significant.
