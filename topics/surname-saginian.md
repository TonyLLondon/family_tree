...
The **Armenian form Saginian** adopts the standard Armenian patronymic suffix ***-ian*** ("son of" or "descendant of"), which functions identically to Georgian *-shvili* or Persian *-zadeh*. The base element ***Sagin-*** appears related to the Armenian word ***saghi*** (սաdelays) — "falcon" or "hawk" — a common basis for Armenian surnames (compare Saghian, Sahagian). If this connection holds, the name means "of the falcon" or "falcon's son," though the Georgian origin may carry a different root meaning that was reinterpreted through Armenian phonetics.
...
| **Saghian** | Armenian | Phonetically related surname (same *sagh-* root); distinct family |
