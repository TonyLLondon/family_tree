...
|--------|-------------|---------|------------|
| c. 1838–1848 | Built by **Mohammad Shah** as **Qasr-e Mohammadieh** (palace-garden) on land previously belonging to the **Mo'ayyer al-Mamalek** family. Shah died of **gout** on entering the palace (1848); it was left abandoned. | Mustawfi memoir (via [Mahdavi email](../sources/mustawfi-mahmoudieh-stump.md)); [Hamshahri (2022)](../sources/hamshahri-mahmoudieh-stump.md) · [translation](../sources/corpus/hamshahri-mahmoudieh-stump/translation.en.md). | High |
| 1850s–1880s | Estate sold post-1848 to **Mohammad Rahim Khan Ala-ud-Dowleh** (chamberlain under Naser al-Din Shah). His youngest son **[Mahmoud Alamir](https://en.wikipedia.org/wiki/Mahmoud_Alamir)** (*Ehtesham al-Saltana*, 27 Jan 1863 – 26 Jan 1936; Qajar diplomat, 2nd Speaker of Parliament, ambassador to the Ottoman Empire 1910–19) builds a new palace and renames it **Mahmoudieh**. | [Hamshahri (2022)](../sources/hamshahri-mahmoudieh-stump.md); Mustawfi (likely); [Iranica — Ehtesham al-Saltana](https://iranicaonline.org/articles/ehtesam-al-saltana-1); [Wikipedia](https://en.wikipedia.org/wiki/Mahmoud_Alamir). | High |
...
**Vault email summary** ([mustawfi-mahmoudieh-stump.md](../sources/mustawfi-mahmoudieh-stump.md)): Mohammad Shah **died before living** in the house; **unlucky** repute; **Mahmoud Alamir** (*Ehtesham al-Saltana*) renamed Muhammadieh → Mahmoudieh and sold to Stump.

**Hamshahri Online (2022)** ([source card](../sources/hamshahri-mahmoudieh-stump.md) · [translation](../sources/corpus/hamshahri-mahmoudieh-stump/translation.en.md)): expands this with the full ownership chain — Ala-ud-Dowleh → Mahmoud Alamir → Sahebdivan → Amin al-Zarb → Stump — and pins the Hotel Esteghlal to the estate's southern edge.

Public wiki and family email both support a Mohammad Shah / Muhammadieh garden-palace and abandonment / bad luck; they differ in detail on whether the shah ever entered the building. The Alamir → Stump chain rests on Mustawfi + the email + Hamshahri until quoted with volume/page from the memoir.
...
**[Vera Obolensky](../people/vera-obolensky.md)** (née Nemtchinova), a Russian émigré, managed a large European-style guesthouse (**40+ rooms**) on the Mahmoudieh estate in the 1920s. The guesthouse catered to European business travelers and was effectively one of Tehran's first foreign-run hotels. Stump provided the property and local connections; Vera handled operations. She later became Stump's partner and then his wife (date unknown; after **Henriette Bottin**'s death). After Stump's death (~1951), Vera left Iran for Frankfurt and then New Jersey, where she died **6 November 1974** (*New York Times* notice **14 November 1974**).
...
|--------|----------|------|
| Mustawfi memoir — legacy email | [sources/mustawfi-mahmoudieh-stump.md](../sources/mustawfi-mahmoudieh-stump.md) | Mahdavi → Henderson email; Mustawfi vol. 1 |
| Hamshahri Online (2022) | [sources/hamshahri-mahmoudieh-stump.md](../sources/hamshahri-mahmoudieh-stump.md) · [corpus](../sources/corpus/hamshahri-mahmoudieh-stump/) · [translation](../sources/corpus/hamshahri-mahmoudieh-stump/translation.en.md) | Ownership chain; ingested via Wayback Machine |
| Beytoote — Stump / Sayyah | [corpus/beytoote-stump-dentist-atabak-ahmadshah/](../sources/corpus/beytoote-stump-dentist-atabak-ahmadshah/) · [translation](../sources/corpus/beytoote-stump-dentist-atabak-ahmadshah/translation.en.md) | §4: villa in old Mahmoudieh |
...
| NYT death notice — Vera Obolensky (14 Nov 1974) | [corpus/vera-obolensky-death-notice-nytimes-2644e85dac/](../sources/corpus/vera-obolensky-death-notice-nytimes-2644e85dac/) | Image-only PDF; read visually |
| "Princess Obolensky" — ProQuest article | [corpus/princess-obolensky-abbcc58ed8/](../sources/corpus/princess-obolensky-abbcc58ed8/) | Contemporaneous press; image-only PDF |
