...
- Wife: **Melici** (surname from handwritten family tree NTree02).
- Children: **Italo** (mentally affected by childhood measles; died returning from Australia), an unnamed daughter (died in her sleep in her thirties), **Graziella** (married, two children), and a fourth.
...
- **Handwritten family tree (NTree02):** [media/docs/fulvia-family-tree-file/NTree02.jpg](../media/docs/fulvia-family-tree-file/NTree02.jpg) — "Giusto m. Melici."

## Open questions

- Full baptismal name — "Giusit" is Dalmatian-Italian; the handwritten tree writes **Giusto**.
- **Melici** — wife's first name.
- Exact dates.
