...
Father of [Pietro Pio Addobbati](pietro-pio-addobbati.md) (**@I20@**) with [Geralda Rovero Brizzi](geralda-rovero-brizzi.md) in **F12** (marriage **26 Oct 1845**, **Zara, Dalmatia**). The GEDCOM lists occupations **computista presso la contabilità dalmata** (**1852**) and **revidente contabile**; **FamilySearch** and **Geni** scrape text align on **1815** birth and **1888** death in **Zara**. Sabalich (p. 508) styles him *Revidente Contabile Luogotenenziale* and *Tenente della guardia Nazionale* (1848).
...
- GEDCOM **`@I23@`**: [archive/gedcom/Upload for MyHeritage 200929.ged](../archive/gedcom/Upload%20for%20MyHeritage%20200929.ged) — **F12** / **F14**; **@S12@**; MyHeritage **Geni** URL in **SOUR**.
