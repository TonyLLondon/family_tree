...
- **5 November 1847** — Born **Reval (Tallinn)** per the MyHeritage / Geni export (**`@I505@`**) and **[BBLD](https://bbld.de/GND1173663347)**. **[German Wikipedia](https://de.wikipedia.org/wiki/Eugen_Edmund_Erbe)** once gave **17 November**; treat **5 November** as the lexicon date unless a **parish image** says otherwise.
...
- **2 November 1879** — Marriage in **Reval** to **Marie von Landesen** (**BBLD**; GEDCOM: **Maria Agnes Elisabeth**). Her father **Carl Friedrich von Landesen** (1802–1883) was a **Tallinn city councilor** (**raehärra**) **1856–1878** per **[et.wikipedia](https://et.wikipedia.org/wiki/Carl_Friedrich_Landesen)** and **[BBLD GND1229738681](https://bbld.de/GND1229738681)**. **Marie** appears as godmother **“Mrs Marie Erbe née von Landesen”** in the **[EBC Stump report](../sources/estonian-biographical-center-stump-report-2005.md)** (Étienne’s **1880** baptism).
- **22 January 1908** — Died **Reval**; **BBLD** *Nachweise* cite **Revalsche Zeitung** / **Revaler Beobachter** **1908** Nr. **19** obituary line.

## Family

- Parents: [Hermann Eberhard Erbe](hermann-eberhard-erbe.md); [Emilie Ida Eylandt](emilie-ida-eylandt.md) (**F140**).
- Sister (vault page): [Olga Caroline Erbe](olga-caroline-erbe.md). Other **F140** siblings remain on the GEDCOM only until each has a register hook.
...
- GEDCOM **`@I505@`**, family **F140**: [archive/gedcom/Upload for MyHeritage 200929.ged](../archive/gedcom/Upload%20for%20MyHeritage%20200929.ged) — vitals, occupation, marriage, **Korporatsioon "Estonia"** / portrait note with **RA.EE Fotis** pointer.
...
- **Portrait** — GEDCOM note links **RA.EE Fotis**; stable `media/` copy and license if you want a local asset.
