...
- **10 Nov 1923** — Born **Zara, Dalmatia** (kingdom-era placename in GEDCOM).
- **20 Dec 2000** — Died **Hove / Brighton & Hove**; death registration indexed **Brighton and Hove, Sussex**.
- **Burial** — **Sirmione, Brescia, Lombardy, Italy** (same cemetery complex as David John Lewis per GEDCOM).
- Occupation in export: **Collector** (treat as label from online tree; confirm from primary record if needed).
...
- Children: [Ivor Anthony Samuel Lewis](ivor-anthony-samuel-lewis.md) and siblings per **F4** in [family-tree.json](../family-tree.json).
...
- Mother **Ester Addobbati** — dedicated `people/` page when parish PDFs are keyed.
