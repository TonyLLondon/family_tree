...
Husband of [Marguerite Emilie Stump](marguerite-emilie-stump.md). A Baltic nobleman living in **Latvia**; the **"von"** prefix signals membership in the Baltic German (*Deutschbalten*) minor nobility.
...
- Wife: [Marguerite Emilie Stump](marguerite-emilie-stump.md) (**F207**).
...
- **treeId** **I562**, family **F207** — same as YAML frontmatter.

## Open questions

- **Birth date, birthplace, death date** — all unknown.
- **Von Frey family** — Baltic German noble lineage not yet researched.
