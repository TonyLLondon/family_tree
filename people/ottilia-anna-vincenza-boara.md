---
name: Ottilia Anna Vincenza Boara
treeId: I21
gedcom: "@I21@"
born: 1865-04-14
...
died: 1937
sex: female
father: simeone-vincenzo-boara
mother: vittoria-elisa-carobbi
spouses:
...
- **14 Apr 1865** — Born **Zara, Dalmatia** (same date on **1890** marriage register; working tree matches).
- **12 Feb 1890** — Marriage **Basilica Metropolitana, Zara** to Pietro Pio Addobbati.
- **1937** — Died (year in working tree only here).

## Family

- Husband: [Pietro Pio Addobbati](pietro-pio-addobbati.md).
- Parents: [Simeone Vincenzo Boara](simeone-vincenzo-boara.md) (**"Possidente, Civile, Vivente"** — property owner, living in 1890); [Vittoria Elisa Carobbi](vittoria-elisa-carobbi.md) (**"Civile, Vivente"** — living in 1890). Both confirmed by the **1890** marriage register.
- Children: [Ester Addobbati](ester-addobbati.md); further siblings in the working tree.
...
- **Marriage register, Entry N. 8, 12 Feb 1890 (Basilica Metropolitana, Zara):** "Boara Ottilia Anna Vincenza, Civile, nata li 14 Aprile 1865"; parents Simeone Boara (Possidente, Vivente) and Vittoria Carobbi (Vivente) — [reference](../sources/corpus/1890-marriage-addobbati-boara-zara/reference.md).
- **Fulvia memoir (1996):** [sources/famhist-nonna-memoir-1996.md](../sources/famhist-nonna-memoir-1996.md) → [famhist-nonna-memoir-1996/](../sources/corpus/famhist-nonna-memoir-1996/) — "my Nonna Ottilia Boara"; borrowing from Casimiro and Carmela Boara; sending a daughter each month.
