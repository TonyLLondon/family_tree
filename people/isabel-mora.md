...
## Parents (indexed only — no descent line in JSON)

Church indexes link a woman named Isabel Mora to **Isidro Mora** and **María Estrada** (marriage side) and to **Isidro + Maria Mora** (1877 burial side). Those findings live in the corpus only:
...
**Rule:** `family-tree.json` does not draw **I701** ← Isidro / María until a film transcription shows ages and names consistent with Valentin’s mother. See [chile-mora-line-evidence-status-2026](../sources/chile-mora-line-evidence-status-2026.md).
...
- [MORA line evidence status](../sources/chile-mora-line-evidence-status-2026.md)
