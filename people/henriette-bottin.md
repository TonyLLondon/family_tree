...
born_alt: 1888-06-26 (GEDCOM @I76@ — reconcile)
died: 1961-06-26
sex: female
...
Daughter of [Fanny Burgess](fanny-burgess.md) and [Julien Bottin](julien-bottin.md). A **French passport *signalement*** in this vault gives a **Tehran birth** and formal description — rare documentary proof of the **next generation’s Persian birthplace** after Fanny’s Tehran life.
...
- Children: see [family-tree.json](../family-tree.json) union **F6** / descendants of **@I11@** [Robert Marc Murard Stump](robert-marc-murard-stump.md) (structured tree is authoritative for full list).
...
- **1886 vs 1888 birth** and **Burgess vs Louise** middle naming — one civil trail or two merged individuals?
- **1961 death** — primary certificate or newspaper notice in `media/docs/`.
